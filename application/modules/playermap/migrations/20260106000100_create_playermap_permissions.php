...
class Migration_Create_playermap_permissions extends CI_Migration
{
    public function up()
    {
        $this->db->insert_batch('permissions', [
            [
                'key'         => 'view.playermap',
                'module'      => 'playermap',
                'description' => 'View playermap dashboard'
            ],
            [
                'key'         => 'manage.playermap.settings',
                'module'      => 'playermap',
                'description' => 'Manage playermap settings'
            ]
        ]);
    ...
    public function down()
    {
        ...
        $this->db->where('module', 'playermap')->delete('permissions');
    }
}
