...
if (!function_exists('get_zone_name_by_id')) {
    function get_zone_name_by_id($zone_id) {
        $zones = get_wow_zones();
        return isset($zones[$zone_id]) ? $zones[$zone_id] : 'Unknown Zone';
    }
}

if (!function_exists('get_wow_zones')) {
    function get_wow_zones() {
        return array(
1 => 'Dun Morogh',
2 => 'Longshore',
3 => 'Badlands',
