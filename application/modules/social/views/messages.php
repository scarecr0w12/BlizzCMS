        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Inbox (<?php echo $unread_count; ?> unread)</h5>
                </div>
                <div class="card-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($messages as $msg): ?>
                                        <tr <?php echo $msg->is_read ? '' : 'class="table-active"'; ?>>
                                            <td><?php echo htmlspecialchars($msg->from_username ?? 'Unknown'); ?></td>
                                ...
                                <ul class="pagination">
                                    <?php for ($i = 1; $i <= ceil($total / $limit); $i++): ?>
                                        <li class="page-item <?php echo $page == $i ? 'active' : ''; ?>">
                                            <a class="page-link" href="<?php echo site_url('social/messages?page=' . $i); ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>
                                </ul>
                            </nav>
