...
class Migration_Create_shop_tables extends CI_Migration
{
    public function up()
    {
        ...
        $this->permission_model->insert_batch([
            ...
            ['key' => 'add.categories', 'module' => 'shop', 'description' => 'Can add shop categories'],
            ['key' => 'edit.categories', 'module' => 'shop', 'description' => 'Can edit shop categories'],
            ['key' => 'delete.categories', 'module' => 'shop', 'description' => 'Can delete shop categories'],
            ['key' => 'view.items', 'module' => 'shop', 'description' => 'Can view shop items'],
            ['key' => 'add.items', 'module' => 'shop', 'description' => 'Can add shop items'],
            ['key' => 'edit.items', 'module' => 'shop', 'description' => 'Can edit shop items'],
            ['key' => 'delete.items', 'module' => 'shop', 'description' => 'Can delete shop items'],
            ['key' => 'view.services', 'module' => 'shop', 'description' => 'Can view shop services'],
            ['key' => 'add.services', 'module' => 'shop', 'description' => 'Can add shop services'],
            ['key' => 'edit.services', 'module' => 'shop', 'description' => 'Can edit shop services'],
            ['key' => 'delete.services', 'module' => 'shop', 'description' => 'Can delete shop services'],
            ['key' => 'view.subscriptions', 'module' => 'shop', 'description' => 'Can view shop subscriptions'],
            ['key' => 'add.subscriptions', 'module' => 'shop', 'description' => 'Can add shop subscriptions'],
            ['key' => 'edit.subscriptions', 'module' => 'shop', 'description' => 'Can edit shop subscriptions'],
            ['key' => 'delete.subscriptions', 'module' => 'shop', 'description' => 'Can delete shop subscriptions'],
            ['key' => 'view.orders', 'module' => 'shop', 'description' => 'Can view shop orders'],
            ['key' => 'process.orders', 'module' => 'shop', 'description' => 'Can process shop orders'],
            ['key' => 'view.payments', 'module' => 'shop', 'description' => 'Can view shop payments'],
            ['key' => 'edit.settings', 'module' => 'shop', 'description' => 'Can edit shop settings']
        ]);
