...
<section class="uk-section uk-section-xsmall">
  <div class="uk-container uk-container-small">
    <h1 class="uk-h2 uk-margin-bottom">Edit Article</h1>
    ...
    <form method="post" class="uk-form-stacked">
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <input class="uk-input" type="text" id="title" name="title" value="<?php echo htmlspecialchars($article->title); ?>" required>
        </div>
      </div>
          ...
          <div class="uk-margin">
            ...
            <div class="uk-form-controls">
              <select class="uk-select" id="tags" name="tags[]" multiple>
                ...
                ?>
                <option value="<?php echo $tag->id; ?>" <?php echo $is_selected ? 'selected' : ''; ?>>
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <textarea class="uk-textarea" id="excerpt" name="excerpt" rows="3"><?php echo htmlspecialchars($article->excerpt); ?></textarea>
        </div>
      </div>
      ...
      <div class="uk-grid-small" uk-grid>
        <div class="uk-width-1-2@m">
          <div class="uk-margin">
            <div class="uk-form-controls">
              <label><input class="uk-checkbox" type="checkbox" name="is_featured" value="1" <?php echo ($article->is_featured ? 'checked' : ''); ?>>
                Featured
              </label>
            </div>
          </div>
        ...
        <div class="uk-width-1-2@m">
          <div class="uk-margin">
            <div class="uk-form-controls">
              <label><input class="uk-checkbox" type="checkbox" name="is_published" value="1" <?php echo ($article->is_published ? 'checked' : ''); ?>>
                Published
              </label>
            </div>
          </div>
