...
<div class="container mt-5">
    <div class="row mb-4">
        <div class="col-md-12">
            <h1><?php echo lang('database_npcs'); ?></h1>
        </div>
    </div>
                ...
                <tbody>
                    <?php foreach ($npcs as $npc): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('database/npc/' . $npc->entry); ?>" class="btn btn-sm btn-primary">
                                    View
                                </a>
                            </td>
                        </tr>
                ...
                <ul class="pagination justify-content-center">
                    ...
                    ?>
                        <li class="page-item <?php echo ($page == $i) ? 'active' : ''; ?>">
                            <a class="page-link" href="<?php echo site_url('database/npcs?page=' . $i); ?>">
                                <?php echo $i; ?>
                            </a>
                        </li>
                    <?php endfor; ?>
