<div class="container mt-4">
    <h1 class="mb-4"><?= lang('leaderboards_honor') ?></h1>

    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= site_url('leaderboards') ?>">Leaderboards</a></li>
            <li class="breadcrumb-item active">Honor Rankings</li>
        </ol>
    </nav>
            ...
            <nav>
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item <?= $i == $current_page ? 'active' : '' ?>">
                        <a class="page-link" href="<?= site_url("leaderboards/honor?page={$i}") ?>">
                            <?= $i ?>
                        </a>
                    </li>
                    <?php endfor; ?>
