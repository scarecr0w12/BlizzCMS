<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">
            <i class="fas fa-plus-circle text-success"></i> Create New Event
        </h2>
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <?= form_open('events/admin/create', ['class' => 'needs-validation']) ?>
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="6" 
                                  required placeholder="Enter event description"><?= set_value('description') ?></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="event_type" name="event_type" required>
                            ...
                            <option value="<?= $type ?>" <?= set_select('event_type', $type) ?>>
                                <?= ucfirst($type) ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="realm_id" name="realm_id">
                            ...
                            <?php if (!empty($realms)): ?>
                                ...
                                <option value="<?= $realm->id ?>" <?= set_select('realm_id', $realm->id) ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="location" name="location" 
                               value="<?= set_value('location') ?>" maxlength="255"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="max_participants" name="max_participants" 
                               value="<?= set_value('max_participants') ?>" min="1" max="1000"
                        ...
                        <div class="card-body">
                            ...
                            <div class="custom-control custom-switch mb-2">
                                <input type="checkbox" class="custom-control-input" id="require_rsvp" 
                                       name="require_rsvp" value="1" <?= set_checkbox('require_rsvp', '1') ?>>
                            ...
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="featured" 
                                       name="featured" value="1" <?= set_checkbox('featured', '1') ?>>
